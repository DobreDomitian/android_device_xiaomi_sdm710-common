...
public class DisplaySettingsFragment extends PreferenceFragment implements
    ...
    private static final String DC_DIMMING_NODE = "/sys/devices/platform/soc/soc:qcom,dsi-display-primary/dimlayer_hbm";
    private SwitchPreference mHBMPreference;
    private static final String HBM_ENABLE_KEY = "hbm_mode";
    private static final String HBM_NODE = "/sys/devices/platform/soc/soc:qcom,dsi-display-primary/fod_hbm_en";
